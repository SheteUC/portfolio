          ...
          <Reveal>
            <h2 className="pointer-events-auto my-2 text-xl sm:text-2xl text-zinc-300 md:my-4 md:text-4xl">
              ...
              <span className="font-semibold text-indigo-500">
                Developer & Venture Analyst
              </span>
            </h2>
          </Reveal>
          <Reveal>
            <p className="pointer-events-auto leading-relaxed md:leading-relaxed max-w-xl text-sm text-zinc-300 md:text-base">
            I&apos;ve worked on everything from automating systems to building responsive web apps. 
            I&apos;m passionate about creating solutions that make a difference. Let&apos;s connect!
            </p>
          </Reveal>
          <Reveal>
            <OutlineButton
